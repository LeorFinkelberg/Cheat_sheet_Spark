...
В Python \emph{составной инфиксный оператор} (например, \texttt{+=}) может работать как с \emph{изменяемыми}, так и с \emph{неизменяемыми} операндами слева от себя. В Scala составной инфиксный оператор может работать только с объектами \emph{изменяемого} типа.
